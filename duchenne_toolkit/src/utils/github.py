...
"""Create a branch off base_branch. Returns the ref name (e.g., 'refs/heads/new_branch')."""
owner, name = _split_repo(repo)
# Get base branch ref
r = requests.get(f"{GITHUB_API}/repos/{owner}/{name}/git/ref/heads/{base_branch}", headers=_headers(token))
